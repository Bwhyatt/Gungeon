...
class TheWall():
    ...
    def WallCollision(self, obj2):
        ...
        # Resets blocked movement directions before checking collision.
    ...
    def ResolveWallCollision(self, obj2):
        ...
        # Calculates how much the object overlaps each side of the wall.
        # The smallest overlap determines which direction the object should be pushed.
        ...
        # Moves the object out of the wall and records which direction is blocked.
        ...
        # Updates the object's rectangle after changing its position.
